...
public interface ISharedEventStreamHandler<TContentPointer, TEventStreamSource, TEventStreamEntry, TListeningHandlers> : IEventStreamHandler<TEventStreamEntry>, ISources<TContentPointer>
...
{
    /// <summary>
    /// A shared collection of all available event streams that should participate in playback of events using their respective <see cref="IEventStreamHandler{TEventStreamEntry}.AdvanceEventStreamAsync"/>. 
    /// </summary>
    /// <remarks>
