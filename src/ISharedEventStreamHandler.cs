...
{
    /// <summary>
    /// A shared collection of all available event streams that should participate in playback of events using their respective <see cref="IEventStreamHandler{TContentPointer, TEventStream, TEventStreamEntry}.AdvanceEventStreamAsync"/>. 
    /// </summary>
    /// <remarks>
